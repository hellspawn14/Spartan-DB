...
START TRANSACTION;
USE `Spartan`;
INSERT INTO `Spartan`.`GroupTournaments` (`idTournament`, `Name`, `Description`, `Sport`, `State`, `idOrganizerGroup`, `Type`, `nParticipants`) VALUES (1, 'Inaguration of Spartan', 'Tournament to conmemorate the creation of Spartan 5 App', 'Soccer', 'Open', 1, 'Public', 4);
...
START TRANSACTION;
USE `Spartan`;
INSERT INTO `Spartan`.`SoloTournament` (`idTournament`, `Name`, `Description`, `Sport`, `State`, `idOrganizerSolo`, `Type`, `nParticipants`) VALUES (1, 'Pokemon VGC', 'Let\'s Play Pokemon VGC Rules', 'Videogames', 'Open', 1, 'Public', 4);
