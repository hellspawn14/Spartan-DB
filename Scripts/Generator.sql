...
START TRANSACTION;
USE `Spartan`;
INSERT INTO `Spartan`.`SoloTournamentEvents` (`idSoloEvent`, `idSoloTournament`, `Date`, `State`, `Place`, `Details`) VALUES (1, 1, '2014/11/15', 'ToStart', '51.508742,-0.120850', 'The event will be held on the second floor');
...
START TRANSACTION;
USE `Spartan`;
INSERT INTO `Spartan`.`GroupTournamentEvents` (`idGroupEvent`, `idGroupTournament`, `Date`, `State`, `Place`, `Details`, `nSpots`) VALUES (1, 1, '2014/10/30 14:00', 'ToStart', '51.508742,-0.120850', 'The event will take place in the third floor', 2);
